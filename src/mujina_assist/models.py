...
class AppPaths:
    ...
    vendored_upstream_dir: Path
    patches_dir: Path
    upstream_patches_dir: Path
    ...
    def from_repo_root(cls, repo_root: Path) -> "AppPaths":
        ...
        vendored_upstream_dir = third_party_dir / "mujina_ros"
        patches_dir = repo_root / "patches"
        upstream_patches_dir = patches_dir / "mujina_ros"
        ...
        return cls(
            ...
            vendored_upstream_dir=vendored_upstream_dir,
            patches_dir=patches_dir,
            upstream_patches_dir=upstream_patches_dir,
            upstream_metadata_file=third_party_dir / "mujina_ros.upstream.json",
...
class RuntimeState:
    ...
    workspace_mode: str = "assisted"
    workspace_upstream_commit: str = ""
    workspace_patch_set_hash: str = ""
    workspace_dirty: bool = False
    workspace_signature: str = ""
    last_workspace_signature: str = ""
    last_action: str = ""
